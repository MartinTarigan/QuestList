...
import 'package:questlist/input.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Use MultiBlocProvider if providing multiple blocs/cubits
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(todo.todoList.length <= 1
                                              ? "0 task"
                                              : "${todo.todoList.length} tasks"),
                                        ),
                                        GestureDetector(
                                          child: ClipRRect(
                                            borderRadius:
    ...
    return showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: InputField(titleController, "Category Name", true),
          actions: [
            TextButton(
              onPressed: () {
